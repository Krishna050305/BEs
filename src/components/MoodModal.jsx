              ...
              {MOOD_OPTIONS.map((mood) => (
                ...
                >
                  <img 
                    src={mood.image} 
                    alt={mood.title} 
                    className="absolute inset-0 w-full h-full object-cover grayscale-0 lg:grayscale group-hover:grayscale-0 active:grayscale-0 transition-all duration-700 group-hover:scale-110 active:scale-110" 
                  />
